...
export default function About() {
  return (
    <section className="space-y-6">
      ...
      <div className="task-card rounded-xl border p-4">
      ...
      <Link
        href="/"
        className="task-input inline-block rounded-xl border px-5 py-3 font-medium hover:bg-gray-100 dark:hover:bg-gray-800"
      >
        ホームへ戻る
      </Link>
    </section>
